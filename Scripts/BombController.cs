...
public class BombController : MonoBehaviour
{
    ...
    [SerializeField] private AudioSource placeBombSoundEffect;
    ...
    Vector3Int bombCellPosition = destructibleTiles.WorldToCell(position);
    position = destructibleTiles.GetCellCenterWorld(bombCellPosition);
